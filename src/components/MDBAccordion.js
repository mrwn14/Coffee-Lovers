...
export default function BMachines() {
  ...
  return (
    <MDBAccordion className="accord" flush initialActive={1}>
      <h1 className="moveLeft text-white">Recommended coffee brewing machines: (click images to Shop)</h1>
      <MDBAccordionItem  collapseId={1} headerTitle='Espresso Machine'>
        ...
        <h1 className="okay2 text-dark"><strong>Breville Espresso Machine</strong> </h1>
        </div>
      ...
      <MDBAccordionItem collapseId={2} headerTitle='Brewing Device'>
        ...
        <h1 className="okay2 text-dark"><strong>Bodum Coffee Maker</strong></h1>
        </div>
      ...
      <MDBAccordionItem collapseId={3} headerTitle='Moka Pot'>
        ...
        <h1 className="okay2 text-dark"><strong>Groshe Moka Pot</strong></h1>
        </div>
        <p><strong>Your coffee rituals</strong>, done right.</p>
